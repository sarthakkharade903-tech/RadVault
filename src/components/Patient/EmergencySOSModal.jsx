...
import { EMERGENCY_CATEGORIES, submitEmergencySOS, parseEmergencyRecord } from '../../services/emergencyService';
...
export default function EmergencySOSModal({ member, onClose, isStandaloneTab = false }) {
  ...
  const handleTriggerSOS = async () => {
    if (!phone || phone.trim().length < 8) {
      setSubmitError('Please enter a valid phone number so hospital staff can contact you immediately.');
      return;
    }
        ...
        <div className="p-4 sm:p-6 overflow-y-auto space-y-5 text-xs font-sans text-slate-800 flex-1">
          ...
          {!activeSOS ? (
            ...
            <div className="space-y-5">
              ...
              {/* 3. Location & 1-Click GPS Beacon (Inspired by 911 CAD) */}
            ...
            <div className="space-y-5">
              ...
              {/* ── Pre-Arrival Life Support Guidance (Inspired by 911 EMD) ── */}
