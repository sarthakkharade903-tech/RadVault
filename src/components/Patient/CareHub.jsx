...
function RxViewModal({ req, member, onClose }) {
  ...
  const facility = notesFacility || session?.facility || req?.facility || "Pune Sassoon General Hospital";
...
export default function CareHub({ member, onOpenEmergency }) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6 pb-32 font-sans text-slate-800 space-y-6">
      ...
      {/* ── 🗺️ How to Reach the Hospital & Transport Options ── */}
      <div className="space-y-3">
        <div className="flex items-center justify-between">
